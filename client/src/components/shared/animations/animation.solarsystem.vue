...
export default {
  ...
  methods: {
    ...
    adjustPlanet(givenName) {
      ...
      const radius = (
        this.sun.radius
        * this.planets[name].sunProportions.radius
        * this.planets[name].factors.radius
      );

      const orbitalRadius = (
        this.planets.earth.orbitalRadius
        * this.planets[name].earthProportions.orbitalRadius
        * this.planets[name].factors.orbitalRadius
        * this.scale
      );

      const orbitalDuration = (
        this.planets.earth.orbitalDuration
        * this.planets[name].earthProportions.orbitalDuration
        * this.planets[name].factors.orbitalDuration
      );
